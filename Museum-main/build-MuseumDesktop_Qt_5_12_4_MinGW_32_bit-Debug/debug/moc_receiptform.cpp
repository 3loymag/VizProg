...
void receiptform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<receiptform *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject receiptform::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_receiptform.data,
    qt_meta_data_receiptform,
    qt_static_metacall,
    nullptr,
    nullptr
} };
