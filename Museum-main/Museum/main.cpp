...
void insertOrUpdateSampleData(QSqlDatabase& db) {
    ...
    if (sampleDataQuery.exec() && sampleDataQuery.next() && sampleDataQuery.value(0).toInt() == 0) {
        ...
        QList<QVariantList> itemsData = {
            {"Printer 1", 500.00, "Краткая информация о принтере 1", "C:\\Users\\loy-m\\Downloads\\Shop-main\\Shop-main\\shopy(26.11.2023)\\printer.png", 11},
            {"Printer 2", 700.00, "Краткая информация о принтере 2", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/printer.png", 12},
            {"Printer 3", 900.00, "Краткая информация о принтере 3", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/printer.png", 8},
            {"Cartridge 1", 600.00, "Краткая информация о картридже 1", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/car.png", 11},
            {"Cartridge 2", 450.00, "Краткая информация о картридже 2", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/car.png", 12},
            {"Cartridge 3", 680.00, "Краткая информация о картридже 3", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/car.png", 8},
            {"Ink 1", 240.00, "Краткая информация о чернилах 1", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/ink.png", 11},
            {"Ink 2", 430.00, "Краткая информация о чернилах 2", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/ink.png", 12},
            {"Ink 3", 520.00, "Краткая информация о чернилах 3", "C:/Users/ilyap/Downloads/shopy(26.11.2023)/ink.png", 8}
        };
